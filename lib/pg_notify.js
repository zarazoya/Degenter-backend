...
// dedicated pool for LISTEN with keepalive and relaxed timeouts
const listenPool = new pg.Pool({
...
export async function pgListen(channel, onMessage) {
  ...
  async function connectAndListen() {
    ...
    // set generous timeouts on this session
    await client.query(`SET statement_timeout = '0'; SET idle_in_transaction_session_timeout = '0';`);
